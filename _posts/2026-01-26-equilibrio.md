...
Al retomar el blog el otro día me di cuenta de que no se estaban sirviendo los acentos. En un principio pensé que, como he cambiado más de veces de servidor que post he escrito, se me había pasado especificar que la página se servía en UTF-8. Pero no, resulta _de que_ la fuente que estaba utilizando, Garamond, no contemplaba el uso de símbolos diacríticos.

Y pensé: Puedo optimizar esto, este es el latemotiv de este blog (ver [aquí]({% post_url 2019-02-18-pasion-por-la-optimizacion %})) Pero también, con la edad, te vas dando cuenta que pese a que no es lo más extremo, lo _más óptimo_ que puedes realizar, crear algo que sea simplemente bonito, también está bien. Y además evita problemas.
